...
_GIFT_ECHO = {
    ...
    "whisper":     "跟她兑现——耳朵凑过去。",
    "candy":       "跟她兑现——伸手。",
    "her_hair":    "跟她兑现——告诉她你要那一缕。",
    "flower":      "跟她兑现——伸手。",
    "hug":         "跟她兑现——张开手臂。",
    "chocolate":   "跟她兑现——伸手。",
    "paper_crane": "跟她兑现——伸手。",
    "her_hour":    "跟她兑现——告诉她要现在。",
    "lucky_dice":  "跟她兑现——伸手。",
    "old_card":    "跟她兑现——告诉她要翻这张。",
    "poem":        "跟她兑现——告诉她你要听。",
    "love_letter": "跟她兑现——告诉她你要拆。",
    "coin":        "跟她兑现——伸手。",
    "star_jar":    "跟她兑现——告诉她你要摇一下。",
    "music_box":   "跟她兑现——告诉她你要听。",
    "bracelet":    "跟她兑现——把手腕递过去。",
    "wish_bottle": "跟她兑现——把它收好。",
    "song":        "跟她兑现——告诉她你要听。",
    "your_story":  "跟她兑现——告诉她你要读。",
    "whole_night": "跟她兑现——告诉她你要今晚。",
}
...
_WEAR_ECHO = {
    "bow":          "跟她兑现——告诉她系在哪边。",
    "cat_ears":     "跟她兑现——把头低下来。",
    "bunny_ears":   "跟她兑现——把头低下来。",
    "cat_tail":     "跟她兑现——告诉她你想戴上。",
    "sunglasses":   "跟她兑现——伸手接过来。",
    "umbrella":     "跟她兑现——伸手。",
    "collar":       "跟她兑现——把脖子伸过去。",
    "bell_collar":  "跟她兑现——把脖子伸过去。",
    "top_hat":      "跟她兑现——把头让出来。",
    "wings":        "跟她兑现——把背给她。",
    "scarf":        "跟她兑现——把脖子给她。",
    "devil_horns":  "跟她兑现——把头让出来。",
    "crown":        "跟她兑现——站好。",
    "star_necklace":"跟她兑现——锁骨给她。",
    "angel_set":    "跟她兑现——告诉她要全套穿。",
}
