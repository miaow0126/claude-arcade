...
def load_game_log(game: str, limit: int = 200) -> list:
    log_file = GAME_DIR / f"{game}_log.jsonl"
...
def push_to_display(last_log: str = ""):
    try:
        payload = {
            ...
            "slots_log": load_game_log("slots"),
            "blackjack_log": load_game_log("blackjack"),
            "roulette_log": load_game_log("roulette"),
            "log": last_log,
        }
